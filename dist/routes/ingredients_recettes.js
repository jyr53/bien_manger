...
const Ingredients_recettesController_1 = require("../controllers/Ingredients_recettesController");
let bodyParser = require('body-parser');
var jsonParser = bodyParser.json();
const Ingredient_recettesController = new Ingredients_recettesController_1.Ingredients_recettesController();
